...
class CommentairePublication(db.Model):
    __tablename__ = 'commentairePublications'
    ...
    # authoriteID = db.Column(db.Integer, db.ForeignKey('authorites.IDauthorite'), nullable=False)
